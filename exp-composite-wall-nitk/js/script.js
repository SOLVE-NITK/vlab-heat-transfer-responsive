...
function validateAnswer1() {
  ...
  if (!answer) {
    ...
    correctAnswer.innerHTML = '<p><span style=" color: #028102;">Correct answer</span> <span style="color: #e7722b;"> Q = '+r+'</span> ';
    console.log("hi " +r);
  } else if (answer) {
...
function validateAnswer2() {
  ...
  if (!answer) {
    correctAnswer.classList.remove("hide");
    unit.innerHTML += " <span class='wrong'>&#x2717;</span>";
    correctAnswer.innerHTML = '<p><span style=" color: #028102;">Correct answer</span> <span style="color: #e7722b;"> K = '+k+'</span> ';
  } else if (answer) {
    correctAnswer.classList.add("hide");
    unit.innerHTML += " <span class='correct'>&#x2713;</span>";
  }
